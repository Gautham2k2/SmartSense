...
try:
    from phase_1.inference import parse_floorplan
except ImportError:
    print("Error: Could not import 'parse_floorplan' from 'phase_1.inference'.")
    sys.exit(1)

MYSQL_DB_URL = "mysql+pymysql://root:admin@localhost:3307/smartsense_db"
